...
int main()
{
    ...
    std::cout << "\nAdding 10 numbers...\n";
    for (int n = 0; n < 10; ++n) cbuf.push_back(n);
    print_cbuf_contents(cbuf);
    ...
    std::cout << "\nAdding 16 (20+n) numbers...\n";
    for (int n = 0; n < 16; ++n) cbuf.push_back(20+n);
    print_cbuf_contents(cbuf);
    ...
    std::cout << "\nTesting reverse iterator... with for loop \n";
    for (cbuf_type::reverse_iterator ri = cbuf.rbegin(); ri != cbuf.rend(); ri++) {
        std::cout << "  value " << *ri << "\n";
    }
