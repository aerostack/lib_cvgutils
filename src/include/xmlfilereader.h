...
public:
    ...
    double readDoubleValue(const std::string &value_location)      ;// throw(cvg_XMLFileReader_exception);
    int readIntValue(const std::string &value_location)            ;// throw(cvg_XMLFileReader_exception);
    std::string readStringValue(const std::string &value_location, std::string xmlfilereader_caller_function =
                    "std::string XMLFileReader::readStringValue(const std::string&, std::string)") ;// throw(cvg_XMLFileReader_exception);
private:
    ...
    const std::vector<std::string> convert_input_string_to_string_stdvector(const std::string &value_location);
};
